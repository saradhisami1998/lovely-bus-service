<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="AboutUs.aspx.cs" Inherits="AboutUsajax" Title="lovely bus: About Us" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content1" runat="Server">
   <%-- <div id="innertitle">
    ...
    <div id="innertitle">
        <table align="center">                           <!-- table will align center -->
            <tr align="left">
    ...
    <div id="staticcontent" style="margin-top: 10px; margin-bottom: 20px">          <!-- setting up margin -->
                            ...
                            <tbody>                               
                                <tr>
                                    <td align="left">
                                                                     <!-- Body Content Starts -->
                                        <p>
                                          <b>LovelyBus</b> is a pioneer in the online bus reservation in India which utilizes
                                            the advantages of the internet to provide our clients with the best in bus transportation
                                            services from the comforts of their homes and offices. LovelyBus provides real-time
                                            Internet quotations and real-time bus booking services to direct customers, agents
                                            and tour operator partners.
                                        </p>
                                        <p>
                                            The idea for LovelyBus has stemmed from the need for simple travel solutions. Buses
                                            ...
                                            tedious processes. LovelyBus aims to provide our customers with a wide range of services
                                        ...
                                        <p>
                                            As a company, LovelyBus believes in engineering win-win relationships with our partners
