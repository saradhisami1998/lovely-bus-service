<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="contactus.aspx.cs" Inherits="contasus" Title="lovely bus: Contact Us" %>
                                        ...
                                        <td valign="middle" colspan="4" height="40">
                                            <table cellspacing="0" cellpadding="2" width="93%" border="0">
                                                <tbody>
                                                                            ...
                                                                            <p style="font-weight: bold; font-size: 18px; font-family: Verdana, Arial, Helvetica, sans-serif"
                                                                                ...
                                                                                <span style="font-weight: bold; font-size: 24px; color: #990000; font-family: Verdana, Arial, Helvetica, sans-serif">
                                                                                    ...
                                                                                    <span style="font-weight: normal; font-size: 11px; line-height: 7mm; font-family: Verdana, Arial, Helvetica, sans-serif">
                                                                                        (Timing: 10:00 am - 10:00 pm, Mon-Sun)n> </span>   
                                                                            </p>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                    ...
                                                    <tr valign="top" align="left">
                                                        <td>
                                                            <font size="3" color="#0066ff"><strong>Saradhi Koradala</strong> </font>
                                                        </td>
                                                        <td>
                                                            &nbsp;
                                                        </td>
                                                        <td>
                                                            <font size="3" color="#0066ff"><strong>Vikranth sai Budarapu</strong> </font>
                                                        </td>
                                                    </tr>
                                                    <tr valign="top" align="left">
                                                    ...
                                                    <tr valign="top" align="left">
                                                        ...
                                                        <td>
                                                                ...
                                                                <strong>Jethmal Agarwal & company,
                                                                <br />
                                                                Bada Bazar,
                                                                <br />
                                                                Bikaner-334001(Raj.)<br />
                                                    ...
                                                    <tr valign="top" align="left">
                                                        <td background="images/reddot.gif" height="1">   <!-- height selection -->
                                                        </td>
                                                    ...
                                                    <tr valign="top" align="center">
                                                        <td colspan="3" height="1">
                                                            or <strong>Email</strong> us at: <a href="#">      <!-- email given -->
                                                                <br />
                                                                lovelybusservices109@gmail.com<br />
                                                               </a>
                                                        </td>
                                                    </tr>
                                                    <br>
