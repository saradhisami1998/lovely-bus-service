<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Change_pass.aspx.cs" Inherits="AdminArea_Change_pass" Title="lovely bus: Change Password" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
 <table align="center" style="text-align:center">
        ...
        <tr><td>
          <table border="0" cellpadding="1" cellspacing="2"      <!-- cell padding -->
                       style="border-collapse:collapse;">      
                       <tr>
                           <td>
                               <table border="0" cellpadding="2" >     <!-- border and size  -->
