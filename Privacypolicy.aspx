<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Privacypolicy.aspx.cs" Inherits="Privacypolicyajax" Title="lovely bus: Privacy Policy" %>
                                                            ...
                                                            <td class="Orangebg" align="left" height="50">
                                                                <p class="maintext" style="margin-left: 3pt">
                                                                    <p>
                                                                        ...
                                                                        of the information of those using the LovelyBus website. Information that can be linked
                                                                    ...
                                                                    <p class="orange11" style="font-size:12px;font-weight:bold ">
                                                                        What personal information does LovelyBus gather from
                                                                    ...
                                                                    <p>
                                                                        All personal information you provide to LovelyBus is transmitted using SSL (Secure
                                                                        ...
                                                                        travel purchases on LovelyBus, you are protected.
                                                                    </p>                                                                  
                                                                    </p>
                                                            </td>
                                                        </tr>
