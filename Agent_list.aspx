...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
 ...
 <center><br /><br />
 <asp:Label ID="lbltitle" Text ="Agents Info" runat="server"  <!-- css -->
         Font-Size="X-Large"   ForeColor="#F7990D" Font-Bold="True"  <!-- all size color and font -->
           /><br /><br />
     <asp:GridView ID="GridView1" runat="server" AllowSorting="True" 
         ...
         <Columns>
             <asp:BoundField DataField="Agent_name" HeaderText="Agent_name"   <!-- agent name  -->
             ...
             <asp:BoundField DataField="Agent_shop_city" HeaderText="Agent_shop_city"   <!-- agent shop city -->
                 SortExpression="Agent_shop_city" />
             <asp:BoundField DataField="Agent_phone_number" HeaderText="Agent_phone_number"   <!--  agent number -->
